...
type ingredients_group struct {
	Title       string       `json:"title"`
	Ingredients []ingredient `json:"ingredients"`
}

type methods_group struct {
	Title   string   `json:"title"`
...
type recipe struct {
	...
	Time        time                `json:"time"`
	Ingredients []ingredients_group `json:"ingredients"`
	Methods     []methods_group     `json:"methods"`
